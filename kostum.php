                ...
                <div class="box-2">
                    <div class="activity-card">
                        ...
                        <table>
                            ...
                            <?php
                            $sql = "SELECT ozellik.ozellik_ad ,kostum.kostum_ad
                                FROM ozellik
                                INNER JOIN kostum ON kostum.ozellik_id=ozellik.ozellik_id;";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<tr>";
                                    echo "<td>" . $row["kostum_ad"] .  "</td>";
                                    echo "<td>" . $row["ozellik_ad"] . "</td>";
