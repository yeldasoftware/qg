...
<body>
  <nav id="navbar">
    ...
    <ul>
      ...
      <li>
        <a class="nav-link" href="sutun.php">Kahramanların Oyun Sayılarına Etkileri Sutün</a>
      </li>
      <li>
        ...
        <div class="box-2">
          <div class="activity-card">
            ...
            <table>
              ...
              <?php
              $sql = "SELECT hikaye.hikaye ,kahramanlar.kahraman_ad
                                FROM hikaye
                                INNER JOIN kahramanlar ON kahramanlar.kahraman_h_id=hikaye.kahraman_h_id;";
