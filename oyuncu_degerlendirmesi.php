      ...
      <div class="box-1">
        ...
        <div class="box-2">
          <div class="activity-card">
            <h3>QUEEN GAME OYUNCU DEĞERLENDİRMESİ</h3>
            ...
            <table>
              ...
              <?php
              $sql = "SELECT oyuncular.id, oyuncular.ad, oyuncular.soyad,oyun.oyun_sayisi,oyun.basari_oranı_yuzdelik
                                FROM oyuncular
                                INNER JOIN oyun ON oyuncular.id=oyun.id";
              ...
              if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<td>" . $row["oyun_sayisi"] . "</td>";
                  echo "<td>" . $row["basari_oranı_yuzdelik"] . "</td>";
