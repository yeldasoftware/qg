...
<body>
  <nav id="navbar">
    ...
    <ul>
      ...
      <li>
        <a class="nav-link" href="sutun.php">Kahramanların Oyun Sayılarına Etkilieri Sütun</a>
      </li>
      <li>
        ...
        <div class="box-2">
          <div class="activity-card">
            ...
            <table>
              ...
              <?php
              $sql = "SELECT kahramanlar.kahramanid, tur.tur_ad, kahramanlar.kahraman_ad
                                FROM kahramanlar
                                INNER JOIN tur ON tur.kahraman_tur_id=kahramanlar.kahraman_tur_id;";
              ...
              if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  echo "<tr>";
                  echo "<td>" . $row["kahramanid"] .  "</td>";
                  echo "<td>" . $row["tur_ad"] . "</td>";
                  echo "<td>" . $row["kahraman_ad"] . "</td>";
